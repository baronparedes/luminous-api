...
const models: TsoaRoute.Models = {
    ...
    "PurchaseOrderAttr": {
        ...
        "properties": {
            "id": {"dataType":"double"},
            "purchaseRequestId": {"dataType":"double","required":true},
            "vendorName": {"dataType":"string","required":true},
            "fulfillmentDate": {"dataType":"datetime","required":true},
            "otherDetails": {"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},
            "chargeId": {"dataType":"double","required":true},
            "description": {"dataType":"string","required":true},
            "totalCost": {"dataType":"double","required":true},
    ...
    "CategoryAttr": {
        ...
        "properties": {
            ...
            "communityId": {"dataType":"double","required":true},
            "description": {"dataType":"string","required":true},
            "subCategories": {"dataType":"string","required":true},
            "createdAt": {"dataType":"datetime"},
            "updatedAt": {"dataType":"datetime"},
            "createdBy": {"dataType":"double"},
            "updatedBy": {"dataType":"double"},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.patch('/api/setting/updateCategories',
            ...
            const args = {
                    body: {"in":"body","name":"body","required":true,"dataType":"array","array":{"dataType":"refObject","ref":"CategoryAttr"}},
            };
